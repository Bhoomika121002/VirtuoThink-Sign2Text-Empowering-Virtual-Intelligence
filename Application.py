...
class Application:
    ...
    def __init__(self):
        ...
        self.root.geometry("600x800")  # Adjusted geometry

        self.panel = tk.Label(self.root)
        self.panel.place(x=50, y=10, width=400, height=400)  # Adjusted size and position
        
        self.panel2 = tk.Label(self.root)  # initialize image panel
        self.panel2.place(x=250, y=40, width=200, height=200)  # Adjusted size and position

        self.T = tk.Label(self.root)
        self.T.place(x=30, y=5)
        self.T.config(text="Sign Language To Text Conversion", font=("Courier", 20, "bold"))

        self.panel3 = tk.Label(self.root)  # Current Symbol
        self.panel3.place(x=230, y=460)
        ...
        self.panel4.place(x=220, y=500)

        self.T2 = tk.Label(self.root)
        self.T2.place(x=10, y=500)
        self.T2.config(text="Word :", font=("Courier", 20, "bold"))

        self.panel5 = tk.Label(self.root)  # Sentence
        self.panel5.place(x=200, y=540)

        self.T3 = tk.Label(self.root)
        self.T3.place(x=10, y=540)
        self.T3.config(text="Sentence :", font=("Courier", 20, "bold"))

        self.T4 = tk.Label(self.root)
        self.T4.place(x=210, y=570)
        self.T4.config(text="Suggestions :", fg="red", font=("Courier", 20, "bold"))

        self.bt1 = tk.Button(self.root, command=self.action1, height=2, width=10)  # Adjusted size
        self.bt1.place(x=10, y=610)

        self.bt2 = tk.Button(self.root, command=self.action2, height=2, width=10)  # Adjusted size
        self.bt2.place(x=210, y=610)

        self.bt3 = tk.Button(self.root, command=self.action3, height=2, width=10)  # Adjusted size
        self.bt3.place(x=410, y=610)
